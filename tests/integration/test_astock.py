"""End-to-end integration test: TradingAgents pipeline on A-stock via live LLM/API.

Requires live credentials and network — excluded from default CI via
``-m "not integration"``.
"""
...
def test_astock_e2e_pipeline():
    """Run TradingAgents pipeline on A-stock 688017 via Kimi 2.6."""
